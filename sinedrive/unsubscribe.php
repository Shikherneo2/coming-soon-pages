...
<title>Sinedrive - Unsubscribe </title>
...
<a href="how_it_works.html"><div id="how_it_works" class="header_sections" style="right:300px;width:150px;">How it Works</div></a>
<a href="about_us.html"><div id="about_us" class="header_sections" style="right:150px;width:150px;">About Us</div></a>
<a href="index.php"><div id="Unsubscribe" class="header_sections" style="right:450px;width:100px;">Home</div></a>
...
<br><br><br>
<font face='oswald-webfont' color="#FFF" size=5><span style="background:#000;padding:10px;opacity:0.90;filter:alpha(opacity=90);">Stop receiving emails from us by Unsubscribing.</span> </font>
<br><br><br>
...
<input type="text" value="Enter Your Email" id="email" name="email" onFocus="has_focus(this)" onMouseUp="return false" onBlur="isEmpty(this)"> &nbsp;<input type="button" value="Unsubscribe" onclick="validateForm()"></form></div>
</div>
<br>
